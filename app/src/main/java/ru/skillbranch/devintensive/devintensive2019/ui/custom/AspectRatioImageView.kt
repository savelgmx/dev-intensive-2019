package ru.skillbranch.devintensive.devintensive2019.ui.custom
...
private var aspectRatio=DEFAULT_ASPECT_RATIO
    ...
    init{
        if(attrs!=null){val a=context.obtainStyledAttributes(attrs, R.styleable.AspectRatioImageView)
